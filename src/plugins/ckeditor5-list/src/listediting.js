...
export default class ListEditing extends Plugin {
	...
	init() {
		...
		editor.commands.add(
			'outdentList',
			new IndentCommand(editor, 'backward')
		);
		...
		this.editor.keystrokes.set(
			'Shift+Tab',
			getCommandExecuter('outdentList')
		);
	}
}
