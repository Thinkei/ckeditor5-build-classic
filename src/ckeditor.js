...
ClassicEditor.create(document.querySelector('#editor'))
	.then(editor => {
		...
		editor.setData(`
		<contract_section hide_title="true" hide_title_in_document="true" id="1160770" is_show="true" optional="true" premium="false" title="Section 0">
		<contract_block block_group="" id="2837235" optional="false" probation="false" visible="true">
		<p>Version 2<br />
		...
		<contract_block block_group="" id="2837210" optional="false" probation="false" visible="true">
		<p><strong>List of duties</strong></p>
		</contract_block>

		<contract_block block_group="" id="2837224" optional="false" probation="false" visible="true">
